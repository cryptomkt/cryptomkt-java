...
public interface CryptomarketWSSpotTradingClient extends CryptomarketWS {
  ...
  /**
   * subscribe to a feed of balances of the user
   * <p>
   * the first notification is a snapshot of the current orders, further
   * notifications are updates of the user orders
   * <p>
   ...
   *                               notifications
   *                               (if any) on equals intervals
   * @param notificationBiconsumer recieves a list of balances
   * @param resultBiConsumer       Optional. recieves true if the subscription is
   *                               successfull, and a CryptomarketSDKException if
   *                               there was a problem (or null if there was none)
   */
  public void subscribeToSpotBalances(@Nullable SubscriptionMode mode,
   ...
   *                         there was a problem (or null if there was none)
   */
  public void unsubscribeToSpotBalances(@Nullable BiConsumer<Boolean, CryptomarketSDKException> resultBiConsumer);
   ...
   * </ul>
   * <p>
   * <b> TimeInForce restrictions:</b>
   * <ul>
   * <li>For an AON order list, orders must be TimeInForce.FOK
   * <li>For an OCO order list, orders must be TimeInForce.GTC, TimeInForce.IOC
   * (except limit orders), TimeInForce.FOK (except limit orders), TimeInForce.DAY
   * or TimeInForce.GTD;
   * <li>For main order in OTOCO order list, there are no restrictions
   * <li>For secondary orders in an OTOCO order list, orders must be
   * TimeInForce.GTC, TimeInForce.IOC (except limit orders), TimeInForce.FOK
   * (except limit orders), TimeInForce.DAY or TimeInForce.GTD;
   * </ul>
   * <p>
   ...
   * @param resultBiConsumer Optional. recieves a report of the first order, and a
   *                         CryptomarketSDKException if there was a problem (or
   *                         null if there was none)
   */
